...
//* import the rootreducer to create the store
...
//* We collect all the reducers and we make them them avaible for the stores
const store = createStore(rootReducer, composeWithDevTools(applyMiddleware(thunk)));

//* We call the actions to initialize the store when starting the app
